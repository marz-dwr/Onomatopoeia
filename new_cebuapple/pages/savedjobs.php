    ...
    <div class="cl-mcont">
        <div class="row">
            <div class="col-md-12 headline">
                <h2><span class="navbar-brand save-header">Saved Jobs</span></h2>
            </div>
            ...
            <div class="col-lg-12 hidden-xs">
                <ul class="list">
                    <a href="#" class="job-desc-sm">
                        <li>
                            <div class="job-list">Tumingin saking mata, magtapat, nang nadarama, di gusto kang mawala, dahil handa akong ibigin ka.</div>
                        </li>
                    </a>
                    <a href="#" class="job-desc-sm">
                        <li>
